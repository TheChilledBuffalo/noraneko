...
import splitViewStyle from "./split-view.pcss?inline"
...
export namespace gSplitView {
    ...
    export function setSplitView(tab: BrowserTab, side: string) {
        ...
        // Check if a tab is already in split view
        ...
        let currentSplitViewPanel = getLinkedPanel(currentSplitViewTab?.linkedPanel) as XULElement;
